...
export function InfoAboutMe(props: InfoAboutMeProps) {
  ...
  const [profileImage, setProfileImage] = useState(userDetails.portfolio.profile_image ? userDetails.portfolio.profile_image : '../../assets/profilepic.png');
  const [heroImage, setHeroImage] = useState(userDetails.portfolio.hero_image ? userDetails.portfolio.hero_image : '../../assets/hero.jpg');
  ...
  const formSumbitHandler = async function (event: any) {
    try {
      ...
      if (response.error === '') {
        showToast('success', 'Settings were successfully changed. Now you can preview you portfolio');
        setUnsaved(true);
      } else {
        ...
        <Box sx={muiStyles.formFields}>
          ...
          <Box sx={muiStyles.bodyField}>
            <FormControl>
              ...
              <div><img className={styles['himg']} src={heroImage}></img></div>
          ...
          <Box sx={muiStyles.bodyField}>
            <FormControl>
              <InputLabel htmlFor="hero_title">Full Name: (userDetails.name)</InputLabel>
              <Input
                type="text"
                id="name"
                name="name"
          ...
          <Box sx={muiStyles.bodyField}>
            ...
            <div><img className={styles['pimg']} src={profileImage}></img></div>
            <UploadImageWidget callback={getUploadedProfileImage} />
          </Box>

          <Box sx={muiStyles.bodyField}>
            <FormControl>
              <InputLabel htmlFor="hero_title">Hero banner description: (portfolio.hero_title)</InputLabel>
              <Input
                type="text"
                id="hero_title"
                name="hero_title"
                onChange={trackChanges}
                defaultValue={userDetails.portfolio.hero_title ? userDetails.portfolio.hero_title : null}
                multiline={true}
              ></Input>
            </FormControl>
          </Box>
          ...
          <Box sx={muiStyles.titleField}>
            <FormControl fullWidth={true}>
              <InputLabel htmlFor="bio_title">Biografy title: (portfolio.bio_title)</InputLabel>
              <Input
                type="text"
                id="bio_title"
                name="bio_title"
                onChange={trackChanges}
                defaultValue={userDetails.portfolio.bio_title ? userDetails.portfolio.bio_title : null}
              ></Input>
            </FormControl>
          </Box>
          ...
          <Box sx={muiStyles.bodyField}>
            <FormControl>
              <InputLabel htmlFor="bio">Biografy description: (portfolio.bio)</InputLabel>
              <Input
                type="text"
                id="bio"
                name="bio"
                onChange={trackChanges}
                defaultValue={userDetails.portfolio.bio ? userDetails.portfolio.bio : null}
                multiline={true}
              ></Input>
            </FormControl>
          </Box>
